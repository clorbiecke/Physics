...
class Particle(Circle):
    ...
    def __init__(self, size=10.0, color=(100,120,255,100), lifetime=1000, to_size=1, to_color=(200,100,50,0), name="Particle", mass:float=1, pos=(0, 0), vel=(0, 0), delta_size=-0.1):
